...
<input value={input} onChange={(e)=>setInput(e.target.value)} type="text" className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' placeholder='Describe What you want to generate' />

     <button type="submit" className='bg-zinc-900 px-10 sm:px-16 py-3 rounded-full' >Generate 
