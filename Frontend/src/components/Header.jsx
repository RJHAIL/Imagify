  ...
  return (
    ...
    <motion.div className='text-stone-500 inline-flex text-center  gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'  initial={{opacity:0, y:-20}} 
     ...
     <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center '>Turn text to <span className='text-blue-600' initial={{opacity:0}} animate={{opacity:1}} transition={{ delay:0.4 , duration:2}}>image</span>  in seconds.</motion.h1>
      <motion.p className='text-center max-w-xl mx-auto mt-5' animate={{opacity:1,y:0}}  initial={{opacity:0, y:20}} 
      ...
      className='flex gap-3 mt-16 justify-center'>
        {Array(6).fill('').map((item,index)=>(
            ...
            duration-500 cursor-pointer max-sm:w-10" 
